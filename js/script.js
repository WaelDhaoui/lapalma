...
// My touch
//Start side-toggle
let side_toggle = [...document.querySelector(".header-right-link .side-toggle button").children]
side_toggle.forEach(function(ele) {
    if (ele.classList.contains("active")) 
        ele.style.display = "initial"
});
//End side-toggle
//Start side-toggle
let custom_menu = document.querySelector("div#menu")
let custom_button = document.querySelector(".header-right-link .side-toggle button")
let navbar_nav = [...document.querySelector("div#menu ul").children]
navbar_nav.forEach(function(ele,j) {
    ele.onclick = function() {
        for(let i=0; i<navbar_nav.length; i++) {
            navbar_nav[i].classList.remove("active")
        }
        ele.classList.add("active")
        side_toggle.forEach(function(element) {
            element.classList.remove("active")
            element.style.display = "none"
        });
        side_toggle[j].classList.add("active")
        side_toggle[j].style.display = "initial"
        custom_menu.classList.remove("show")
...
let text_toggle_btn = document.querySelectorAll(".btn_container .text")
let plats = document.querySelector(".speciality .plats-container");
let galettes = document.querySelector(".speciality .galettes-container");
